...
public class NhacNoHoaDonService {
    ...
    private static final class NoiDungNhacNo {
        ...
        private NoiDungNhacNo(String ten, String phong, String ky, String tong) {
            this.ten = ten;
            this.phong = phong;
            this.ky = ky;
            this.tong = tong;
        ...
        static NoiDungNhacNo tu(HoaDon hoaDon, KhachThue nguoiNhan) {
        ...
        String plain() {
            return String.format(
                    "Kính gửi %s,\n\n"
                            + "Hệ thống ghi nhận hóa đơn của bạn đang ở trạng thái chưa thanh toán:\n"
                            + "- Phòng: %s\n- Kỳ: %s\n- Tổng cộng: %s\n\n"
    ...
    public Optional<String> guiNhacNo(String maHoaDon, String kenh) {
        ...
        NoiDungNhacNo nd = NoiDungNhacNo.tu(hoaDon, nguoiNhan);
        String noiDung = nd.plain();
        String noiDungHtml = nd.html();
